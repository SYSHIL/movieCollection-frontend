...
const EditMovie = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios.get(`https://movie-collection-backend-bl3t-iv0bq1c5j-syshils-projects.vercel.app/movie/${id}`)
    .then((response) => {
  ...
  const handleEditMovie = () => {
    ...
    setLoading(true);
    axios
      .put(`https://movie-collection-backend-bl3t-iv0bq1c5j-syshils-projects.vercel.app/movie/update/${id}`, data)
      .then(() => {
        setLoading(false);
